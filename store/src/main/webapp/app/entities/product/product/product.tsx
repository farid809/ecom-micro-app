            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.productProduct.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('productSize')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('productSize')} />
                </th>
