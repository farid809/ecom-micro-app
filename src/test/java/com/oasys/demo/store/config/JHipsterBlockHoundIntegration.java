package com.oasys.demo.store.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.oasys.demo.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.oasys.demo.store.security.DomainUserDetailsService", "createSpringSecurityUser");
