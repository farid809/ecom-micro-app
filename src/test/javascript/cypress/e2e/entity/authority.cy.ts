...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '6d9a6c6c-6649-47fd-b329-9e5c460341e1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('0ddb0a0d-1e99-4dd6-ac34-6db3d38f2878');
      cy.get(`[data-cy="name"]`).should('have.value', '0ddb0a0d-1e99-4dd6-ac34-6db3d38f2878');
