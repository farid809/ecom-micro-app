...
describe('OrderItem Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RouterTestingModule.withRoutes([]), OrderItemUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 31863 };
      orderItem.product = product;

      const productCollection: IProduct[] = [{ id: 31989 }];
    ...
    it('Should call ProductOrder query and add missing value', () => {
      const orderItem: IOrderItem = { id: 456 };
      const order: IProductOrder = { id: 21351 };
      orderItem.order = order;

      const productOrderCollection: IProductOrder[] = [{ id: 8201 }];
    ...
    it('Should update editForm', () => {
      const orderItem: IOrderItem = { id: 456 };
      const product: IProduct = { id: 9046 };
      orderItem.product = product;
      const order: IProductOrder = { id: 7249 };
      orderItem.order = order;
