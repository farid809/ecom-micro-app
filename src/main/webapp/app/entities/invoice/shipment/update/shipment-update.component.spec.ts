...
describe('Shipment Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RouterTestingModule.withRoutes([]), ShipmentUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Invoice query and add missing value', () => {
      ...
      const invoice: IInvoice = { id: 25373 };
      shipment.invoice = invoice;

      const invoiceCollection: IInvoice[] = [{ id: 21976 }];
    ...
    it('Should update editForm', () => {
      const shipment: IShipment = { id: 456 };
      const invoice: IInvoice = { id: 17531 };
      shipment.invoice = invoice;
