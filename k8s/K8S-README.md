...
```
$ docker image tag invoice farid809/invoice
$ docker push farid809/invoice
$ docker image tag notification farid809/notification
$ docker push farid809/notification
$ docker image tag product farid809/product
$ docker push farid809/product
$ docker image tag store farid809/store
$ docker push farid809/store
```
...
```
kubectl scale deployment <app-name> --replicas <replica-count> -n ecom3
```
...
```
kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n ecom3
```
...
```
kubectl get svc jhipster-prometheus -n ecom3
```
...
```
kubectl get svc jhipster-grafana -n ecom3
```
